...
Run the Conversate `conversate:regen` flow. Plugin source is this repo. The installed CLI lives under the Plugin installation root (`~/.conversate/` by default) and rebuilds derived indexes for the Conversation database (`~/.conversate/convs/`).
